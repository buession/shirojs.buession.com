...
<template>
  <div>
    <div v-if="shiro.hasAnyRole('admin', 'seller') === true">用户不具有 admin 或 seller 角色</div>
    <div v-if="shiro.hasAnyRole('admin', 'seller') === false">用户具有 admin 和 seller  角色</div>
  </div>
</template>
...
<template>
  <div>
    <div v-if="shiro.hasRolesAll('admin', 'seller') === true">用户不具有 admin 和 seller 角色</div>
    <div v-if="shiro.hasRolesAll('admin', 'seller') === false">用户具有 admin 或 seller  角色</div>
  </div>
</template>
...
<template>
  <div>
    <div v-if="shiro.hasAnyPermission('user:add', 'user:edit') === true">用户不具有 user:add 或 user:edit 权限</div>
    <div v-if="shiro.hasAnyPermission('user:add', 'user:edit') === false">用户具有 user:add 和 user:edit  权限</div>
  </div>
</template>
...
<template>
  <div>
    <div v-if="shiro.hasPermissionsAll('user:add', 'user:edit') === true">用户不具有 user:add 和 user:edit 权限</div>
    <div v-if="shiro.hasPermissionsAll('user:add', 'user:edit') === false">用户具有 user:add 或 user:edit  权限</div>
  </div>
</template>
